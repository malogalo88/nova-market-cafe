...
/*
    CineLite :: gbuffers_entities.fsh
    Same fake-lighting model as terrain + hurt-flash tint.
*/
...
uniform float far;
uniform vec4 entityColor;         /* red hurt flash */
...
void main(){
    ...
    vec3 light = sceneLight(vNormalW, Vw, sunDirW, el, vLM, 0.0,
                            rainStrength, 0.0, heldBlockLightRange,
