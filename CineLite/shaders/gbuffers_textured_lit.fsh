...
/*
    CineLite :: gbuffers_textured_lit.fsh
    Lightmapped particles: smoke, flames, block-break puffs...
*/
...
void main(){
    ...
    vec3 light = particleLight(vLM, el, rainStrength, frameTimeCounter);
    vec3 color = tex.rgb * vColor.rgb * light;
    ...
    gl_FragData[2] = vec4(vLM.x, vLM.y, 1.0, 0.0);
}
